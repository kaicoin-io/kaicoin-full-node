...
#ifndef KAICOINPARAMLIST_H
#define KAICOINPARAMLIST_H

static const mc_OneKaicoinParam KaicoinParamArray[] =
{
    { "chainprotocol"                          , "chain-protocol"                          ,
                   ...
                   "Chain protocol: kaicoin (permissions, native assets) or bitcoin"},
...
*/                   
    ...
    { "chainname"                              , "chain-name"                              ,
                   ...
                   "protocolversion","",
                   "Chain name, used as first argument for kaicoind and kaicoin-cli."},                   
