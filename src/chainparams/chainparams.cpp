...
/* MCHN START */
static Checkpoints::MapCheckpoints mapCheckpointsKaicoin =
        boost::assign::map_list_of
        ( -1, uint256("0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"))
        ;
static const Checkpoints::CCheckpointData dataKaicoin = {
        &mapCheckpointsKaicoin,
        0,
        0,
        0
    };
...
class CKaiCoinParams : public CMainParams {
public:
    CKaiCoinParams() {    };
    
    void SetFixedParams(const char *NetworkName)
    {
        networkID = CBaseChainParams::KAICOIN;
...
//        convertSeed6(vFixedSeeds, pnSeed6_test, ARRAYLEN(pnSeed6_test));
    ...
    void SetKaiCoinParam(const char*param_name,int64_t value)
    {
...
static CKaiCoinParams kaiCoinParams;


bool SelectKaiCoinParams(const char *NetworkName)
{
    SelectKaiCoinBaseParams(NetworkName,(int)mc_gState->m_NetworkParams->GetInt64Param("defaultrpcport"));

    kaiCoinParams.SetFixedParams(NetworkName);
    
    kaiCoinParams.Initialize();
    
    pCurrentParams = &kaiCoinParams;
...
void SetKaiCoinParams()
{
    kaiCoinParams.SetKaiCoinParams();
}

void SetKaiCoinParam(const char*param_name,int64_t value)
{
    kaiCoinParams.SetKaiCoinParam(param_name,value);
}


void SetKaiCoinRuntimeParams()
{
    kaiCoinParams.SetKaiCoinRuntimeParams();
}

bool InitializeKaiCoinParams()
{
    
    kaiCoinParams.Initialize();
    
    kaiCoinParams.SetGenesis();
