...
#ifndef KAICOIN_STATE_H
#define	KAICOIN_STATE_H

#include "utils/define.h"
#include "chainparams/params.h"
#include "protocol/kaicoinscript.h"
...
{    
    const mc_OneKaicoinParam *m_Param;
    int64_t m_Value;    
    uint32_t m_Block;
    int32_t m_Skipped; 
...
{    
    ...
    mc_Params               *m_Params;
    mc_KaicoinParams     *m_NetworkParams;
    ...
    void  InitDefaults()
    {
        ...
        m_NetworkParams=new mc_KaicoinParams;
        m_Permissions=NULL;
        m_Assets=NULL;
