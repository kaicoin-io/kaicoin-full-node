...
bool ParseKaicoinTxOutToBuffer(uint256 hash,                                 // IN, tx hash, if !=0 genesis asset reference is retrieved from asset DB
...
bool ParseKaicoinTxOutToBuffer(uint256 hash,                                 // IN, tx hash, if !=0 genesis asset reference is retrieved from asset DB
                                  ...
                                  string& strFailReason)                        // OUT error
{
    return ParseKaicoinTxOutToBuffer(hash,txout,amounts,lpScript,allowed,required,NULL,strFailReason);
}
