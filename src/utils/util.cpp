...
#include "kaicoin/kaicoin.h"                                              // MCHN
...
/* MCHN START */
static boost::filesystem::path pathCachedKaiCoin;
...
/* MCHN START */
    ...
    pathCachedKaiCoin=fs::path(string(mc_gState->m_Params->DataDir()));
    fs::path &path =pathCachedKaiCoin;
    return path;
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "kaicoin.pid"));
