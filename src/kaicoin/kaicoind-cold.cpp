...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        fprintf(stderr,"\nError: Data directory %s needs to exist before calling kaicoind-cold. Exiting...\n\n",mapArgs["-datadir"].c_str());
        return false;        
    }
        ...
        (mc_gState->m_Params->NetworkName() == NULL))
    {
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  kaicoind-cold <blockchain-name> [options]                     " + _("Start KaiCoin Offline Daemon") + "\n";
