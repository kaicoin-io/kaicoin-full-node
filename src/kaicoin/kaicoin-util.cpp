...
int main(int argc, char* argv[])
{
    ...
    mc_KaicoinParams* params;
    mc_KaicoinParams* paramsOld;
...
//                    err=params->Create(mc_gState->m_Params->m_Arguments[1],version);
                ...
                { 
                    ...
                    printf("You can edit it in %s before running kaicoind for the first time.\n\n",fileName);
                    printf("To generate blockchain please run \"kaicoind %s -daemon\".\n",params->Name());
                }                
                else
                {
        ...
        if(strcmp(mc_gState->m_Params->Command(),"clone") == 0)
        {
            ...
            {
                params=new mc_KaicoinParams;
                paramsOld=new mc_KaicoinParams;
...
*/        
    ...
    if(err == MC_ERR_OPERATION_NOT_SUPPORTED)
    {
        ...
        printf("Usage:\n");
        printf("  kaicoin-util create <blockchain-name>  ( <protocol-version> = %d ) [options]        Creates new kaicoin configuration file %s with default parameters\n",
        ...
        printf("  kaicoin-util clone <old-blockchain-name> <new-blockchain-name> [options]               Creates new kaicoin configuration file %s copying parameters\n",fileName);
